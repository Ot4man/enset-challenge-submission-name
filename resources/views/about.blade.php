...
<div class="about-card" style="text-align: center;">
    <img src="/assets/img/avatar.png" style="width: 150px; height: 150px; border-radius: 50%; border: 4px solid var(--primary); margin-bottom: 2rem; box-shadow: 0 0 30px rgba(244,63,94,0.3);">
    ...
    <p style="font-size: 1.2rem; line-height: 1.8; color: var(--text-dim); text-align: left;">
    ...
    <div style="margin-top: 4rem; padding: 2rem; background: rgba(239,68,68,0.05); border: 1px solid rgba(239,68,68,0.2); border-radius: 1rem; text-align: left;">
